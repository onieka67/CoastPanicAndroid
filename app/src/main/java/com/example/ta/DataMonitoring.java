...
public class DataMonitoring implements Parcelable {
    ...
    public DataMonitoring(String idkapal, String idlatitude, String idlongitude, String idstatus, String idtime) {
    ...
    protected DataMonitoring(Parcel in) {
